...
const createSettingsMutation = gql`
  mutation createIssue($name: String!, $url: String!, $trainerId: ID) {
    createIssue(name: $name, url: $url, trainerId: $trainerId) {
      channel {
        id
      }
    }
...
export const SettingsFormWithMutation = graphql(createSettingsMutation)(SettingsForm)
